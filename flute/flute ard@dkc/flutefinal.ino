...
bool lringclosed=(datlring<=470);
//bool lringhalfclosed=((datlring>490)  &&  (datlring<=550));
bool lringopen=(datlring>470);
//Serial.println(datlring)
//Serial.println(datlring);//  below 570 570 to 630 and above

bool lmiddleclosed=(datlmiddle<=540);
//bool lmiddlehalfclosed=((datlmiddle>510)  &&  (datlmiddle<=600));
bool lmiddleopen=(datlmiddle>540);
//Serial.println(datlmiddle);// below 570 570 to 630 and above 

bool lindexclosed=(datlindex<=510);
//bool lindexhalfclosed=((datlindex>510)  &&  (datlindex<=620));
bool lindexopen=(datlindex>510);
//Serial.println(datlindex);//working fine below 540 540 to 600 and above     
//Serial.println(datrring);
bool rringclosed=(datrring<=570);
//bool rringhalfclosed=((datrring>570)  &&  (datrring<=580));
bool rringopen=(datrring>570);
...
//bool rindexhalfclosed=((datrindex>550) && (datrindex<=580));
bool rindexopen=(datrindex>550);
//Serial.println(datrindex);//awesome below 540 540 to 600 and above
bool blow=(datablow>520);
